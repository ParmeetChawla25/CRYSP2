      ...
      <Container fluid>
        <Navbar className="z-100" id="navbar">
          ...
          <Nav className="mr-auto w-100">
            ...
            <Button href="./accuracy" className="w-15 ml-4">
              AccuCheck
            </Button>
            ...
            <Dropdown.Item>
              {
                <div
                  onClick={() => {
                    ...
                    document.getElementById("totalSymbol").innerText = "$ ";
                    document.getElementById("totalVal").textContent = (
                      userValue * 1.0
                    ).toFixed(5);
                    const ele_arr =
                      document.getElementsByClassName("coinKiVals");
                    for (var i = 0; i < ele_arr.length; i++) {
                      ele_arr[i].innerHTML =
                        "$ " +
                        `${parseFloat(prices.get(ele_arr[i].id) * 1.0).toFixed(
                          5
                        )}`;
                    }
                  }}
                ...
                <div
                  onClick={() => {
                    ...
                    for (var i = 0; i < ele_arr.length; i++) {
                      ele_arr[i].innerHTML =
                        "€ " +
                        `${parseFloat(prices.get(ele_arr[i].id) * 0.95).toFixed(
                          5
                        )}`;
                    }
                  }}
                ...
                <div
                  onClick={() => {
                    ...
                    for (var i = 0; i < ele_arr.length; i++) {
                      ele_arr[i].innerHTML =
                        "£ " +
                        `${parseFloat(prices.get(ele_arr[i].id) * 0.83).toFixed(
                          5
                        )}`;
                    }
                  }}
                  ...
                  onClick={() => {
                    ...
                    for (var i = 0; i < ele_arr.length; i++) {
                      ele_arr[i].innerHTML =
                        "₩ " +
                        `${parseFloat(
                          prices.get(ele_arr[i].id) * 1334.0
                        ).toFixed(5)}`;
                    }
                  }}
                >
          ...
          <Col md="8" className="h-100 m-0 p-0 pb-2 pl-2">
            ...
            >
              <h3 className="text-center mt-3 mb-2 pb-0">
                Total Value: <span id="totalSymbol">$</span>
                <span id="totalVal">{userValue}</span>
              </h3>
              <PieChart
                ...
                <ListGroup variant="flush" className="h-88">
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="bitcoin" className="coinKiVals">
                        $&nbsp;{prices.get("bitcoin")}
                      </span>
                    </div>
                  </ListGroup.Item>
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="ethereum" className="coinKiVals">
                        $&nbsp;{prices.get("ethereum")}
                      </span>
                    </div>
                  </ListGroup.Item>
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="tether" className="coinKiVals">
                        $&nbsp;{prices.get("tether")}
                      </span>
                    </div>
                  </ListGroup.Item>
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="xrp" className="coinKiVals">
                        $&nbsp;{prices.get("xrp")}
                      </span>
                    </div>
                  </ListGroup.Item>
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="bitcoinCash" className="coinKiVals">
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="bitcoinSV" className="coinKiVals">
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="litecoin" className="coinKiVals">
                        $&nbsp;{prices.get("litecoin")}
                      </span>
                    </div>
                  </ListGroup.Item>
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="binancecoin" className="coinKiVals">
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="eos" className="coinKiVals">
                        $&nbsp;{prices.get("eos")}
                      </span>
                    </div>
                  </ListGroup.Item>
                  ...
                  >
                    ...
                    <div className="h5 d-inline float-right">
                      <span id="tezos" className="coinKiVals">
                        $&nbsp;{prices.get("tezos")}
                      </span>
                    </div>
                  </ListGroup.Item>
