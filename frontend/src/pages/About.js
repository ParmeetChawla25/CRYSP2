          ...
          >
            ...
            >
              ...
              <div className="h-75">
                ...
                <br></br>
                <br></br>
                Users will immediately receive their <b className="text-primary">initial start-up cash of $10,000</b> after registering. From that point onwards, you are <b className="text-primary">free to purchase, trade, and invest</b> in the cryptocurrencies we support. We use our own trading charts and exchange histories to assist your strategic decisions.
                <br></br>
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                <b className="text-primary"><a href="mailto:lit2020013@iiitl.ac.in">Yashvardhan</a></b>,{" "}
                <b className="text-primary"><a href="mailto:lit2020015@iiitl.ac.in">Parmeet</a></b>,{" "}
                <b className="text-primary"><a href="mailto:lit2020016@iiitl.ac.in">Akshay</a></b> and{" "}
